...
public class ViewApprovedWorkers extends AppCompatActivity {

    String TAG = ViewApprovedWorkers.class.getSimpleName();
    Utils utils;
    RequestQueue queue;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_approved_workers);

        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setDisplayShowHomeEnabled(true);

        setTitle("Approved Workers");
    ...
    void GetWorkersFromServer(){
        ...
        try {
            params.put(DataAttributes.REQUEST_OPTION, "get_auth_emp");
