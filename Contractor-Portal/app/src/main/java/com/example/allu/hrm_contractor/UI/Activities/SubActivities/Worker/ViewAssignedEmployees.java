...
public class ViewAssignedEmployees extends AppCompatActivity {
    String TAG = ViewAssignedEmployees.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_assigned_employees);
    ...
    void GetWorkersFromServer(){
        ...
        try {
            params.put(DataAttributes.REQUEST_OPTION, "get_assigned_emp");
