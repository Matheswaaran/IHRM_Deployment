...
public class ViewUnAssignedWorkers extends AppCompatActivity {
    String TAG = ViewUnAssignedWorkers.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_un_assigned_workers);

        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setDisplayShowHomeEnabled(true);

        setTitle("Un Assigned Workers");
    ...
    void GetWorkersFromServer(){
        ...
        try {
            params.put(DataAttributes.REQUEST_OPTION, "get_unassigned_emp");
