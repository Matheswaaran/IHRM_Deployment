...
frame=Frame(root)
frame.pack()
w = Label(root,text="PROJECT IHRM")
w.pack()

w = Label(root,text="Face recognizer")
w.pack()

bottomframe=Frame(root)
bottomframe.pack(side=TOP)
#blackbutton.config(width=200,height=200)
blackbutton=Button(bottomframe,text="Create",fg="black",command=facecreation)
blackbutton.pack(side=TOP)
blackbutton.config(width=40,height=3)
#b=Button(root,text="Create",command=callback)
#b.pack()
blackbutton=Button(bottomframe,text="Recognize",fg="black",command=recognise)
blackbutton.pack(side=TOP)
blackbutton.config(width=40,height=3)
#c=Button(root,text="Recognize",command=callback)
#c.pack()
blackbutton=Button(bottomframe,text="Train",fg="black",command=train)
blackbutton.pack(side=TOP)
blackbutton.config(width=40,height=3)
#d=Button(root,text="Train",command=callback)
#d.pack()
blackbutton=Button(bottomframe,text="Quit",fg="black",command=train)
blackbutton.pack(side=TOP)
blackbutton.config(width=40,height=3)
