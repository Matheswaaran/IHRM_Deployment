...
public class CompletedRequests extends AppCompatActivity {
    String TAG = CompletedRequests.class.getSimpleName();
    Utils utils;
    RequestQueue queue;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        requirment_clickInterface = new Requirment_clickInterface() {
            @Override
    ...
    void LoadYourRequests(){
        ...
        try {
            params.put(DataAttributes.REQUEST_OPTION, "get_res_requests");
