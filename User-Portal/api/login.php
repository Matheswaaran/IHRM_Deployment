...
//    $en_password = $session->encryptIt($password);
    ...
    if (isset($email) && isset($password)){
        ...
        if (!$db){
            ...
            $select_sql = "SELECT * FROM users_table WHERE email_id = '$email' AND password = '$password'";
